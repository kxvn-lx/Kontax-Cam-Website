            ...
            <Fade>
                <div className="relative">
                    ...
                    <JournalWrapper className="mt-20">
                        ...
                        <h1>Design</h1>
                        <Image imageName="j_2.jpeg" className="mt-10 mb-4 w-1/2 ml-10 md:ml-0" />
                        ...
                        <p className="text-sm font-semibold">Taken with #kontaxcam</p>
                        <p>I'm not an expert. Heck, I just graduated! But armed with gen-z mind and creativity, I was determined to do my best. I built Kontax Cam in a span of ~2 to 3 months give or take.</p>
