...
function IndexPage() {
    ...
    return (
        <Layout>
            ...
            <Fade>
                <div className="grid grid-cols-1 gap-10 mx-auto">
                    <div className="text-center m-auto">
                        <h1 className="fluid text-3xl md:text-6xl font-bold mt-4">The instant camera hybrid app for creative people and photographers.</h1>
                        ...
                        <div className="mt-20">
                            ...
                            <div className="mt-10">
                                <Modal modalTitle="Or scan the barcode">
                                    <div className="w-3/4">
                                        <img className="h-40 w-40" style={{ borderRadius: '1.25rem' }} src={require("../images/barcodeSVG.svg")} alt="Kontax Cam barcode" />
            ...
            <div className="mt-20">
                <h1 className="font-bold text-2xl md:text-6xl text-center">Why you'll love<br />Kontax Cam</h1>
                <Fade>
