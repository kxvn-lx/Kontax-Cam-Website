            ...
            <Fade>
                <div className='relative'>
                    ...
                    <div className='md:ml-10'>
                        <p className='text-kontax-secondary-text max-w-2xl text-justify'>
                            By contributing to an open-source software, not only
                            benefits you, but it also benefits the whole
                            society. This can be a one-time thing, contribute
                            something and done, or a recurring thing. Whatever
                            it is, it's your choice. You control your own
                            decision.
                        </p>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-20 md:ml-10'>
                    {helpList.map((item) => (
                        <div
                            key={item.title}
                            className='flex md:w-9/12 items-center'
                        >
                            <div>
